...
exports.portfolio = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        technologies: 'Express.js / Node.js, Javascript, HTML, CSS, Jade',
        status: 'online'
      }
    ]
  },
    ...
    items: [
      {
        ...
        technologies: 'Debian, PowerPC-Hardware',
        status: 'released'
      },
      {
        header: 'yafc Patch #1',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        link_text: 'website',
        description: 'Installation, configuration and modification of Linux on mobile systems.',
        technologies: 'Debian, Linux, Laptops',
        status: 'online'
      },
      {
      ...
      },
      {
        ...
        technologies: 'C, GTK+ 2.x, GNOME 2.x, autoconf',
        status: 'released'
      },
      {
        ...
        technologies: 'C, GTK+ 2.0, OpenGL 1.3, autoconf',
        status: 'unfinished'
      },
      {
        header: 'bubblemon',
    ...
    items: [
      {
        ...
        technologies: 'Linux, Windows, PHP, Sybase, HTML, Javascript, Java, C, C++, Fortran',
        status: 'online'
      }
    ]
  }
